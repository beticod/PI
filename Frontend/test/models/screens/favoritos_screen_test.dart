...
import 'package:bbiblioteca/screens/favoritos_screen.dart';
...
void main() {
  ...
  testWidgets('FavoritosScreen se construye correctamente', (tester) async {
    ...
    // NO usamos pumpAndSettle porque el Future nunca termina
