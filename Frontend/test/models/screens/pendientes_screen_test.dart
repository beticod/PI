...
import 'package:bbiblioteca/screens/pendientes_screen.dart';
...
void main() {
  ...
  testWidgets('PendientesScreen se construye correctamente', (tester) async {
    await tester.pumpWidget(
      wrap(const PendientesScreen()),
    );
